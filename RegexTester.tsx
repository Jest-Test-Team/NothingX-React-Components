...
export function RegexTester() {
  ...
  return (
    <div style={{ padding: 14, borderRadius: nothing.radius.card, background: nothing.colors.surface }} aria-label="Regex tester">
      ...
      <input type="text" value={pattern} onChange={(e) => { setPattern(e.target.value); setError(null); }} placeholder="/pattern/" style={{ width: '100%', marginBottom: 6, padding: 8, borderRadius: 8, border: `1px solid ${nothing.colors.circleBg}`, background: nothing.colors.bg, color: nothing.colors.surfaceLight, fontFamily: 'monospace' }} />
